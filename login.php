  ...
  <nav>
    ...
    <i class="fa fa-bars" onclick="showMenu()"></i>
     ...
     <div class="sub-header-title">
        ...
        <h1>Login to your Account to continue with our services</h1>
     </div>
...
<section class="register">
    ...
    <section class="faqs registerbox">
        <h1>Take me to my account.</h1>

    <div class="query-box register-login-box">
        <h3>Login.</h3>

        <form action="login_user.php" method="post" class="comment-form">
        ...
        <?php
            ...
            else if(strpos($fullUrl,"error=passwordinvalid")==true){
                echo "<p class='error'>Invalid Email or Password!</p>";
                exit();
            }


            else if(strpos($fullUrl,"emailnotexist")==true){
                echo "<p class='error'>Invalid Email or Password!</p>";
                exit();
            }
            ?>
