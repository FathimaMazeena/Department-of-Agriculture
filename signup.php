...
<h1>Register and be the one out of a handful to enrol for our services!</h1>
    ...
    <section class="register">
        ...
        <section class="faqs registerbox">
            <h1>Join Our Community of Farmers.</h1>

        <div class="query-box register-login-box">
            <h3>Create Your Account.</h3>

            <form action="signup_user.php" method="post" class="comment-form">
            ...
            <div class="button">
                <button type="submit" name="register" class="submit-button">Create My Account</button>
            </div>
            </form>
